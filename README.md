...
[![Build Status](https://travis-ci.org/apaliavy/msbotbuilder-go.svg?branch=develop)](https://travis-ci.org/apaliavy/msbotbuilder-go) [![GoDoc](https://godoc.org/github.com/apaliavy/msbotbuilder-go?status.svg)](https://godoc.org/github.com/apaliavy/msbotbuilder-go)
...
```sh
$ go get -u github.com/apaliavy/msbotbuilder-go/...
```
